            ...
            <div className="relative flex items-start gap-6">
              <div className="flex-1 space-y-3">
                ...
                {[
                  ...
                  { role: "bot", text: "We offer a 30-day money-back guarantee on all plans. To request a refund, simply contact our support team with your order number and reason for the request. Refunds are processed within 5-7 business days." },
              ...
              <div className="hidden md:block">
                <div className="w-px h-40 bg-border mx-6" />
              </div>
              <div className="hidden md:block w-64 space-y-3 text-sm">
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Embed in seconds</p>
                <div className="bg-slate-950 rounded-lg p-3 font-mono text-xs text-slate-300 border border-slate-800">
                  ...
                  <span className="text-blue-400 pl-2">src</span><span className="text-slate-400">="</span><span className="text-green-400">/widget.js</span><span className="text-slate-400">"</span><br />
                  <span className="text-blue-400 pl-2">data-chatbot-uid</span><span className="text-slate-400">="</span><span className="text-yellow-400">your-uid</span><span className="text-slate-400">"</span><br />
                  <span className="text-slate-500">{">"}</span><span className="text-slate-500">{"</"}script</span><span className="text-slate-500">{">"}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {plans.map((plan) => (
              ...
              >
                {plan.highlighted && (
                  <Badge className="self-start mb-4 text-xs">Most popular</Badge>
                )}
